...
class _ConcertsInRangeScreenState extends State<ConcertsInRangeScreen> {
  ...
  void initState() {
    ...
    concertsFuture = _ticketmasterService.getConcerts(
      start,
      end,
  ...
  Widget build(BuildContext context) {
    ...
    String titleDate = "";
    if (widget.startDate.day == widget.endDate.day &&
      ...
      titleDate =
          "${DateFormat('d MMM', currentLocale).format(widget.startDate)} - ${DateFormat('d MMM', currentLocale).format(widget.endDate)}"
              .toUpperCase();
    }
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            l10n.homeErrorNoEvents(widget.countryCode),
            style: TextStyle(
          ...
          if (widget.city != null)
            Text(
              'No encontramos eventos en ${widget.city}',
