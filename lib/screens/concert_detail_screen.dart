...
class _ConcertDetailScreenState extends State<ConcertDetailScreen> with TickerProviderStateMixin {
  ...
  Widget _buildSectionTitle(String title) {
    return Text(title, style: const TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w800));
  }
  ...
  Widget _buildInfoRow(IconData icon, String text) {
    return Row(
      ...
      children: [
        ...
        Expanded(child: Text(text, style: const TextStyle(color: Colors.white, fontSize: 15, height: 1.3))),
      ],
    );
  }
