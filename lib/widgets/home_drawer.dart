      ...
      child: SafeArea(
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  ...
                  Expanded(child: Text(displayName, style: TextStyle(color: primaryText, fontSize: 20, fontWeight: FontWeight.bold), overflow: TextOverflow.ellipsis)),
                ]),
            ...
            _menuItem(context, l10n.menuAccount, Icons.account_circle, AccountScreen(userProfile: userProfile, authSource: authSource)),
            ...
            ListTile(
              ...
              trailing: ConstrainedBox(
                ...
                child: Text(
                  currentCity != null ? "$currentCountryCode - $currentCity" : currentCountryCode,
              ...
              onTap: () async {
                ...
                final result = await Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => RegionScreen(currentCountryCode: currentCountryCode)),
                );
